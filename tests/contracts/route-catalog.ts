...
const ROUTE_FILES = [
  ...
  'src/app/api/comfyui/connections/[connectionId]/probe/route.ts',
  'src/app/api/comfyui/connections/[connectionId]/route.ts',
  ...
  'src/app/api/viral-replications/[id]/video-link/route.ts',
