...
const TASK_TYPE_OWNER_MAP = {
  ...
  [TASK_TYPE.STORYBOARD_SHEET_GENERATE]: 'tests/unit/worker/storyboard-sheet-task-handler.test.ts',
  [TASK_TYPE.STORYBOARD_SHEET_UPSCALE]: 'tests/unit/worker/storyboard-sheet-task-handler.test.ts',
  ...
  [TASK_TYPE.EDITOR_AUTO_CUT]: 'tests/unit/worker/editor-auto-cut.test.ts',
  ...
  [TASK_TYPE.VIRAL_VIDEO_ANALYSIS]: 'tests/unit/worker/viral-replication-worker.test.ts',
  [TASK_TYPE.VIRAL_STORYBOARD_GENERATION]: 'tests/unit/worker/viral-replication-worker.test.ts',
