...
describe('guided workflow translations', () => {
  const requiredKeys = [
    ...
    'manualCorrectionsTitle', 'manualCorrectionLabel', 'manualCorrectionPlaceholder',
    'manualCorrectionClear', 'manualCorrectionNoCandidates', 'manualCorrectionSelectedField',
    'manualCorrectionInvalid',
    'mappingEditorTitle', 'mappingEditorHint', 'inputMappingsTitle', 'noInputMappings',
    'mappedRole', 'mappingRoleFor', 'removeMapping', 'removeInputMappingLabel',
    'addInputMapping', 'chooseWorkflowField', 'workflowField', 'chooseMappingRole',
    'newMappingRole', 'confirmInputMapping', 'cancelMapping', 'outputMappingsTitle',
    'outputNode', 'historyField', 'outputMappingName', 'primaryOutput',
    'usePrimaryOutput', 'removeOutputLabel', 'addOutputMapping', 'outputRequired',
    'mappingDraftIssues',
