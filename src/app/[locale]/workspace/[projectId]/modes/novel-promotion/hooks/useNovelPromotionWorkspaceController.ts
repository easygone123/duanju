...
export function useNovelPromotionWorkspaceController({
  ...
  const execution = useWorkspaceExecution({
    ...
    storyboardGenerationMode: projectSnapshot.storyboardGenerationMode,
    sixGridCellAspectRatio: projectSnapshot.sixGridCellAspectRatio,
    sixGridProcessingOrder: projectSnapshot.sixGridProcessingOrder,
    storyboardUpscaleModel: projectSnapshot.storyboardUpscaleModel,
    dialogueVideoModel: projectSnapshot.dialogueVideoModel,
    t,
    onRefresh,
