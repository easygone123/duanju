  ...
  return <div className="space-y-5">
    <section aria-labelledby="workflow-input-mappings">
      ...
      <div className="mt-2 space-y-2">
        {bindings.map((binding, index) => <div key={index} className="grid gap-2 rounded-xl border border-[var(--glass-stroke-base)] p-3 sm:grid-cols-2 xl:grid-cols-5">
    ...
    <section aria-labelledby="workflow-output-mappings">
      ...
      <div className="mt-2 space-y-2">{outputs.map((output, index) => <div key={index} className="grid gap-2 rounded-xl border border-[var(--glass-stroke-base)] p-3 sm:grid-cols-2 xl:grid-cols-5">
