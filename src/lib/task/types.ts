...
export const TASK_TYPE = {
  ...
  STORYBOARD_SHEET_GENERATE: 'storyboard_sheet_generate',
  STORYBOARD_SHEET_UPSCALE: 'storyboard_sheet_upscale',
  ...
  EDITOR_AUTO_CUT: 'editor_auto_cut',
...
export type QueueType = 'image' | 'video' | 'voice' | 'text' | 'viral'
