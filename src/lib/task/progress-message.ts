...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.STORYBOARD_SHEET_GENERATE]: 'progress.taskType.storyboardSheetGenerate',
  [TASK_TYPE.STORYBOARD_SHEET_UPSCALE]: 'progress.taskType.storyboardSheetUpscale',
  ...
  [TASK_TYPE.EDITOR_AUTO_CUT]: 'progress.taskType.editorAutoCut',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  comfy_waiting_capacity: 'progress.stage.comfyWaitingCapacity',
  comfy_checking_compatibility: 'progress.stage.comfyCheckingCompatibility',
  comfy_uploading_inputs: 'progress.stage.comfyUploadingInputs',
  comfy_submitting: 'progress.stage.comfySubmitting',
  comfy_running: 'progress.stage.comfyRunning',
  comfy_transferring_outputs: 'progress.stage.comfyTransferringOutputs',
  comfy_reconciling: 'progress.stage.comfyReconciling',
